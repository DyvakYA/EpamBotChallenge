...
public class OriginalSnakeResponse extends AbstractSnakeResponse {

    private static final Logger log = Logger.getLogger(OriginalSnakeResponse.class);

    public OriginalSnakeResponse(Board board) {
        super();
        this.board = board;
