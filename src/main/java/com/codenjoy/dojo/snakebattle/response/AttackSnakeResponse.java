...
public class AttackSnakeResponse extends AbstractSnakeResponse {

    private static final Logger log = Logger.getLogger(AttackSnakeResponse.class);

    public AttackSnakeResponse(Board board) {
        super();
        this.board = board;
