...
import com.codenjoy.dojo.snakebattle.direction.FlySnakeDirection;
...
import com.codenjoy.dojo.snakebattle.strategy.FlySnakeStrategy;
import com.codenjoy.dojo.snakebattle.strategy.SnakeStrategy;

public class FlySnake implements Snake {

    private Board board;

    public FlySnake(Board board) {
        this.board = board;
    }
    ...
    public SnakeStrategy getStrategy() {
        return new FlySnakeStrategy(board);
    }

    @Override
    public SnakeDirection getDirection() {
        return new FlySnakeDirection(board);
    }
