...
import com.codenjoy.dojo.snakebattle.direction.LargeSnakeDirection;
...
import com.codenjoy.dojo.snakebattle.strategy.LargeSnakeStrategy;
import com.codenjoy.dojo.snakebattle.strategy.SnakeStrategy;

public class LargeSnake implements Snake {

    private Board board;

    public LargeSnake(Board board) {
        this.board = board;
    }

    @Override
    public SnakeStrategy getStrategy() {
        return new LargeSnakeStrategy(board);
    }

    @Override
    public SnakeDirection getDirection() {
        return new LargeSnakeDirection(board);
    }
