...
import com.codenjoy.dojo.snakebattle.direction.AttackSnakeDirection;
...
import com.codenjoy.dojo.snakebattle.strategy.AttackSnakeStrategy;
import com.codenjoy.dojo.snakebattle.strategy.SnakeStrategy;

public class AttackSnake implements Snake {
    private Board board;

    public AttackSnake(Board board) {
        this.board = board;
    }

    @Override
    public SnakeStrategy getStrategy() {
        return new AttackSnakeStrategy(board);
    }

    @Override
    public SnakeDirection getDirection() {
        return new AttackSnakeDirection(board);
    }
